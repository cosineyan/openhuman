...
const messages: TranslationMap = {
  ...
  'topics.tab': 'Themen',
  'topics.title': 'Themen-Threads',
  'topics.subtitle': 'Inhalte aus mehreren Quellen zu einer Themen-Zeitleiste zusammenfassen.',
  'topics.new': '+ Neues Thema',
  'topics.newTitle': 'Neues Thema',
  'topics.editTitle': 'Thema bearbeiten',
  'topics.loading': 'Wird geladen…',
  'topics.emptyTitle': 'Noch keine Themen',
  'topics.emptyDesc':
    'Erstelle ein Thema, um zugehörige E-Mails, Chats und Meetings automatisch zu bündeln.',
  'topics.chip.keywords': 'Schlüsselwörter',
  'topics.chip.sources': 'Quellen',
  'topics.chip.entities': 'Personen',
  'topics.field.name': 'Name',
  'topics.field.namePlaceholder': 'z. B. Projekt Phoenix Q3',
  'topics.field.description': 'Beschreibung',
  'topics.field.descriptionPlaceholder': 'Was dieses Thema abdeckt…',
  'topics.field.keywordLogic': 'Schlüsselwort-Abgleich',
  'topics.logic.or': 'Beliebiges Wort (ODER)',
  'topics.logic.and': 'Alle Wörter (UND)',
  'topics.field.keywords': 'Schlüsselwörter',
  'topics.field.keywordsPlaceholder': 'Wort eingeben, Enter drücken',
  'topics.field.sources': 'Angeheftete Quellen',
  'topics.field.noSources': 'Keine Speicherquellen konfiguriert.',
  'topics.field.entities': 'Angeheftete Personen / Entitäten',
  'topics.field.entitiesPlaceholder': 'z. B. person:jane-doe, Enter drücken',
  'topics.timeline': 'Zeitleiste',
  'topics.timelineEmpty':
    'Noch keine Inhalte gebündelt – warten auf nächste Synchronisierung/Zusammenfassung.',
  'topics.current': 'Aktuell',
  'topics.save': 'Speichern',
  'topics.saving': 'Wird gespeichert…',
  'topics.cancel': 'Abbrechen',
  'topics.delete': 'Thema löschen',
  'topics.confirmDelete':
    'Dieses Thema löschen? Die gebündelten Zusammenfassungen bleiben erhalten.',
  'topics.err.nameRequired': 'Name ist erforderlich.',
  'topics.chip.conversations': 'Chats',
  'topics.chip.people': 'Personen',
  'topics.field.conversations': 'Teams-Chats',
  'topics.field.noConversations':
    'Noch keine Teams-Chats — zuerst Teams-Nachrichten synchronisieren.',
  'topics.field.searchConversations': 'Chats nach Name suchen…',
  'topics.field.people': 'Personen',
  'topics.field.noPeople': 'Noch keine Personen — zuerst E-Mail oder Teams synchronisieren.',
  'topics.field.searchPeople': 'Personen nach Name oder E-Mail suchen…',
  'topics.field.pasteLink': 'Teams-Chat-Link einfügen…',
  'topics.field.addLink': 'Hinzufügen',
  'topics.field.resolving': 'Wird aufgelöst…',
  'topics.chip.meetings': 'Meetings',
  'topics.field.meetings': 'Meetings',
  'topics.field.meetingsPlaceholder': 'Meetingname oder Teil eingeben, Enter drücken',
  'topics.field.noMeetings': 'Noch keine Meetings — zuerst Teams-Transkripte synchronisieren.',
  'topics.field.searchMeetings': 'Meetings nach Name suchen…',
  'topics.field.backfill': 'Verlauf nachfüllen',
