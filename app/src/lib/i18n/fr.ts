...
const messages: TranslationMap = {
  ...
  'topics.tab': 'Sujets',
  'topics.title': 'Fils de sujets',
  'topics.subtitle': 'Regroupez le contenu de plusieurs sources dans une chronologie par sujet.',
  'topics.new': '+ Nouveau sujet',
  'topics.newTitle': 'Nouveau sujet',
  'topics.editTitle': 'Modifier le sujet',
  'topics.loading': 'Chargement…',
  'topics.emptyTitle': 'Aucun sujet pour l’instant',
  'topics.emptyDesc':
    'Créez un sujet pour regrouper automatiquement les e-mails, discussions et réunions associés.',
  'topics.chip.keywords': 'mots-clés',
  'topics.chip.sources': 'sources',
  'topics.chip.entities': 'personnes',
  'topics.field.name': 'Nom',
  'topics.field.namePlaceholder': 'ex. Projet Phoenix T3',
  'topics.field.description': 'Description',
  'topics.field.descriptionPlaceholder': 'Ce que couvre ce sujet…',
  'topics.field.keywordLogic': 'Correspondance des mots-clés',
  'topics.logic.or': 'N’importe quel mot (OU)',
  'topics.logic.and': 'Tous les mots (ET)',
  'topics.field.keywords': 'Mots-clés',
  'topics.field.keywordsPlaceholder': 'Saisissez un mot, appuyez sur Entrée',
  'topics.field.sources': 'Sources épinglées',
  'topics.field.noSources': 'Aucune source mémoire configurée.',
  'topics.field.entities': 'Personnes / entités épinglées',
  'topics.field.entitiesPlaceholder': 'ex. person:jane-doe, appuyez sur Entrée',
  'topics.timeline': 'Chronologie',
  'topics.timelineEmpty':
    'Aucun contenu regroupé pour l’instant — en attente de la prochaine synchronisation/synthèse.',
  'topics.current': 'Actuel',
  'topics.save': 'Enregistrer',
  'topics.saving': 'Enregistrement…',
  'topics.cancel': 'Annuler',
  'topics.delete': 'Supprimer le sujet',
  'topics.confirmDelete': 'Supprimer ce sujet ? Les synthèses regroupées sont conservées.',
  'topics.err.nameRequired': 'Le nom est requis.',
  'topics.chip.conversations': 'discussions',
  'topics.chip.people': 'personnes',
  'topics.field.conversations': 'Discussions Teams',
  'topics.field.noConversations':
    'Aucune discussion Teams — synchronisez d’abord les messages Teams.',
  'topics.field.searchConversations': 'Rechercher des discussions par nom…',
  'topics.field.people': 'Personnes',
  'topics.field.noPeople': 'Aucune personne — synchronisez d’abord l’e-mail ou Teams.',
  'topics.field.searchPeople': 'Rechercher des personnes par nom ou e-mail…',
  'topics.field.pasteLink': 'Collez un lien de discussion Teams…',
  'topics.field.addLink': 'Ajouter',
  'topics.field.resolving': 'Résolution…',
  'topics.chip.meetings': 'réunions',
  'topics.field.meetings': 'Réunions',
  'topics.field.meetingsPlaceholder':
    'Saisissez un nom de réunion ou une partie, appuyez sur Entrée',
  'topics.field.noMeetings': 'Aucune réunion — synchronisez d’abord les transcriptions Teams.',
  'topics.field.searchMeetings': 'Rechercher des réunions par nom…',
  'topics.field.backfill': 'Remplir l’historique',
