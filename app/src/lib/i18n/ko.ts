...
const messages: TranslationMap = {
  ...
  'topics.tab': '주제',
  'topics.title': '주제 스레드',
  'topics.subtitle': '여러 소스의 콘텐츠를 주제별 타임라인으로 모읍니다.',
  'topics.new': '+ 새 주제',
  'topics.newTitle': '새 주제',
  'topics.editTitle': '주제 편집',
  'topics.loading': '불러오는 중…',
  'topics.emptyTitle': '아직 주제가 없습니다',
  'topics.emptyDesc': '관련 이메일, 채팅, 회의를 자동으로 모으려면 주제를 만드세요.',
  'topics.chip.keywords': '키워드',
  'topics.chip.sources': '소스',
  'topics.chip.entities': '사람',
  'topics.field.name': '이름',
  'topics.field.namePlaceholder': '예: 프로젝트 피닉스 Q3',
  'topics.field.description': '설명',
  'topics.field.descriptionPlaceholder': '이 주제가 다루는 내용…',
  'topics.field.keywordLogic': '키워드 일치',
  'topics.logic.or': '아무 키워드 (OR)',
  'topics.logic.and': '모든 키워드 (AND)',
  'topics.field.keywords': '키워드',
  'topics.field.keywordsPlaceholder': '키워드 입력 후 Enter',
  'topics.field.sources': '고정된 소스',
  'topics.field.noSources': '구성된 메모리 소스가 없습니다.',
  'topics.field.entities': '고정된 사람 / 엔티티',
  'topics.field.entitiesPlaceholder': '예: person:jane-doe, Enter 누르기',
  'topics.timeline': '타임라인',
  'topics.timelineEmpty': '아직 모인 콘텐츠가 없습니다 — 다음 동기화/요약을 기다리는 중.',
  'topics.current': '현재',
  'topics.save': '저장',
  'topics.saving': '저장 중…',
  'topics.cancel': '취소',
  'topics.delete': '주제 삭제',
  'topics.confirmDelete': '이 주제를 삭제할까요? 모인 요약은 유지됩니다.',
  'topics.err.nameRequired': '이름은 필수입니다.',
  'topics.chip.conversations': '채팅',
  'topics.chip.people': '사람',
  'topics.field.conversations': 'Teams 채팅',
  'topics.field.noConversations': '아직 Teams 채팅이 없습니다 — 먼저 Teams 메시지를 동기화하세요.',
  'topics.field.searchConversations': '이름으로 채팅 검색…',
  'topics.field.people': '사람',
  'topics.field.noPeople': '아직 사람이 없습니다 — 먼저 이메일 또는 Teams를 동기화하세요.',
  'topics.field.searchPeople': '이름 또는 이메일로 사람 검색…',
  'topics.field.pasteLink': 'Teams 채팅 링크 붙여넣기…',
  'topics.field.addLink': '추가',
  'topics.field.resolving': '확인 중…',
  'topics.chip.meetings': '회의',
  'topics.field.meetings': '회의',
  'topics.field.meetingsPlaceholder': '회의 이름 또는 일부 입력 후 Enter',
  'topics.field.noMeetings': '아직 회의가 없습니다 — 먼저 Teams 대화록을 동기화하세요.',
  'topics.field.searchMeetings': '이름으로 회의 검색…',
  'topics.field.backfill': '기록 채우기',
  'topics.backfill.none': '없음',
  'topics.backfill.label': '채우기:',
  'topics.backfill.done': '백필 대기열에 추가됨 — 타임라인이 곧 업데이트됩니다.',
  // Claude settings profiles
  'claudeProfiles.title': 'Claude 프로필',
  'claudeProfiles.menuDesc': 'Claude Code settings.json 파일과 모델을 등록합니다',
  'claudeProfiles.desktopOnly': '데스크톱에서만 사용할 수 있습니다.',
  'claudeProfiles.intro':
    'Claude Code settings.json 파일을 등록하세요. 작업은 프로필과 모델을 선택할 수 있으며, AI 실행은 claude --settings <경로>로 시작됩니다. 파일의 인증 토큰은 절대 읽거나 표시되지 않습니다.',
  'claudeProfiles.registered': '등록된 프로필',
  'claudeProfiles.loading': '불러오는 중…',
  'claudeProfiles.empty': '아직 프로필이 없습니다.',
  'claudeProfiles.unreadable': '파일을 읽을 수 없음',
  'claudeProfiles.remove': '제거',
  'claudeProfiles.addTitle': '프로필 추가',
  'claudeProfiles.addDesc':
    'settings.json 파일을 지정하세요. 예: ~/.claude/settings.json.hyperspace',
  'claudeProfiles.nameLabel': '이름',
  'claudeProfiles.namePlaceholder': '예: Hyperspace',
  'claudeProfiles.pathLabel': 'settings 파일 경로',
  'claudeProfiles.adding': '추가 중…',
  'claudeProfiles.add': '프로필 추가',
  'claudeProfiles.picker.none': '아직 Claude 프로필이 없습니다 — 설정에서 추가하세요.',
  'claudeProfiles.picker.default': '기본값 (프로필 없음)',
  'claudeProfiles.picker.modelDefault': '기본 모델',
  'claudeProfiles.parsing': '분석 중…',
  'claudeProfiles.previewUnreadable': '파일을 찾을 수 없거나 읽을 수 없습니다.',
  'claudeProfiles.previewNoModels': '이 파일에서 모델 키를 찾을 수 없습니다.',
  'claudeProfiles.ladderTitle': '폴백 사다리',
  'claudeProfiles.ladderDesc':
    '작업 폴백에 사용되는 전역 모델 순서. 모델 시작에 실패하면 작업이 이 사다리를 따라(위 또는 아래로) 폴백합니다.',
  'claudeProfiles.ladderEmpty': '사다리를 만들려면 프로필을 추가하세요.',
  'claudeProfiles.picker.fallback': '시작 실패 시 폴백',
  'claudeProfiles.picker.down': '사다리 아래로',
  'claudeProfiles.picker.up': '사다리 위로',
  'claudeProfiles.picker.endBoundary': '끝: 사다리 경계',
  'claudeProfiles.picker.endPrefix': '종료 지점',
  'claudeProfiles.globalTitle': '전역 기본값 (프로필 없는 작업)',
  'claudeProfiles.globalDesc':
    '자체 프로필을 선택하지 않은 작업은 이 폴백을 사용합니다. 끄면 앱 기본 모델로 실행됩니다.',
  'claudeProfiles.globalEnable': '전역 기본 폴백 활성화',
  'claudeProfiles.globalStart': '시작 모델…',
  'claudeProfiles.globalNoLadder': '사다리를 만들려면 먼저 프로필을 추가하세요.',
  'claudeProfiles.globalSentStart': '시작',
  'claudeProfiles.globalSentStep': '방향',
  'claudeProfiles.globalSentDown': '아래로',
