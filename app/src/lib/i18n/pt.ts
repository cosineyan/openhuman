...
const messages: TranslationMap = {
  ...
  'topics.subtitle': 'Agregue conteúdo de várias fontes em uma linha do tempo por tópico.',
  'topics.new': '+ Novo tópico',
  'topics.newTitle': 'Novo tópico',
  'topics.editTitle': 'Editar tópico',
  'topics.loading': 'Carregando…',
  'topics.emptyTitle': 'Ainda não há tópicos',
  'topics.emptyDesc':
    'Crie um tópico para agregar automaticamente e-mails, chats e reuniões relacionados.',
  'topics.chip.keywords': 'palavras-chave',
  'topics.chip.sources': 'fontes',
  'topics.chip.entities': 'pessoas',
  'topics.field.name': 'Nome',
  'topics.field.namePlaceholder': 'ex. Projeto Phoenix T3',
  'topics.field.description': 'Descrição',
  'topics.field.descriptionPlaceholder': 'O que este tópico abrange…',
  'topics.field.keywordLogic': 'Correspondência de palavras-chave',
  'topics.logic.or': 'Qualquer palavra (OU)',
  'topics.logic.and': 'Todas as palavras (E)',
  'topics.field.keywords': 'Palavras-chave',
  'topics.field.keywordsPlaceholder': 'Digite uma palavra, pressione Enter',
  'topics.field.sources': 'Fontes fixadas',
  'topics.field.noSources': 'Nenhuma fonte de memória configurada.',
  'topics.field.entities': 'Pessoas / entidades fixadas',
  'topics.field.entitiesPlaceholder': 'ex. person:jane-doe, pressione Enter',
  'topics.timeline': 'Linha do tempo',
  'topics.timelineEmpty':
    'Nenhum conteúdo agregado ainda — aguardando a próxima sincronização/resumo.',
  'topics.current': 'Atual',
  'topics.save': 'Salvar',
  'topics.saving': 'Salvando…',
  'topics.cancel': 'Cancelar',
  'topics.delete': 'Excluir tópico',
  'topics.confirmDelete': 'Excluir este tópico? Os resumos agregados são mantidos.',
  'topics.err.nameRequired': 'O nome é obrigatório.',
  'topics.chip.conversations': 'chats',
  'topics.chip.people': 'pessoas',
  'topics.field.conversations': 'Chats do Teams',
  'topics.field.noConversations':
    'Ainda não há chats do Teams — sincronize as Mensagens do Teams primeiro.',
  'topics.field.searchConversations': 'Buscar chats por nome…',
  'topics.field.people': 'Pessoas',
  'topics.field.noPeople': 'Ainda não há pessoas — sincronize e-mail ou Teams primeiro.',
  'topics.field.searchPeople': 'Buscar pessoas por nome ou e-mail…',
  'topics.field.pasteLink': 'Cole um link de chat do Teams…',
  'topics.field.addLink': 'Adicionar',
  'topics.field.resolving': 'Resolvendo…',
  'topics.chip.meetings': 'reuniões',
  'topics.field.meetings': 'Reuniões',
  'topics.field.meetingsPlaceholder': 'Digite um nome de reunião ou parte, pressione Enter',
  'topics.field.noMeetings': 'Ainda não há reuniões — sincronize transcrições do Teams primeiro.',
  'topics.field.searchMeetings': 'Buscar reuniões por nome…',
  'topics.field.backfill': 'Preencher histórico',
  'topics.backfill.none': 'Nenhum',
  'topics.backfill.label': 'Preencher:',
  'topics.backfill.done': 'Preenchimento na fila — a linha do tempo será atualizada em breve.',
  // Claude settings profiles
  'claudeProfiles.title': 'Perfis do Claude',
  'claudeProfiles.menuDesc': 'Registre arquivos settings.json do Claude Code e seus modelos',
  'claudeProfiles.desktopOnly': 'Disponível apenas no desktop.',
  'claudeProfiles.intro':
    'Registre seus arquivos settings.json do Claude Code. As tarefas podem escolher um perfil e modelo; a execução de IA inicia com claude --settings <caminho>. Os tokens de autenticação nunca são lidos nem exibidos.',
  'claudeProfiles.registered': 'Perfis registrados',
  'claudeProfiles.loading': 'Carregando…',
  'claudeProfiles.empty': 'Ainda não há perfis.',
  'claudeProfiles.unreadable': 'arquivo ilegível',
  'claudeProfiles.remove': 'Remover',
  'claudeProfiles.addTitle': 'Adicionar perfil',
  'claudeProfiles.addDesc':
    'Aponte para um arquivo settings.json, ex.: ~/.claude/settings.json.hyperspace',
  'claudeProfiles.nameLabel': 'Nome',
  'claudeProfiles.namePlaceholder': 'ex.: Hyperspace',
  'claudeProfiles.pathLabel': 'Caminho do arquivo settings',
  'claudeProfiles.adding': 'Adicionando…',
  'claudeProfiles.add': 'Adicionar perfil',
  'claudeProfiles.picker.none': 'Ainda não há perfis do Claude — adicione um nas Configurações.',
  'claudeProfiles.picker.default': 'Padrão (sem perfil)',
  'claudeProfiles.picker.modelDefault': 'Modelo padrão',
  'claudeProfiles.parsing': 'Analisando…',
  'claudeProfiles.previewUnreadable': 'Arquivo não encontrado ou ilegível.',
  'claudeProfiles.previewNoModels': 'Nenhuma chave de modelo encontrada neste arquivo.',
  'claudeProfiles.ladderTitle': 'Escada de fallback',
  'claudeProfiles.ladderDesc':
    'Ordem global de modelos usada pelo fallback de tarefas. Uma tarefa recorre a esta escada (para cima ou para baixo) quando seu modelo não inicia.',
  'claudeProfiles.ladderEmpty': 'Adicione um perfil para construir a escada.',
  'claudeProfiles.picker.fallback': 'Fallback em falha de inicialização',
  'claudeProfiles.picker.down': 'Descer a escada',
  'claudeProfiles.picker.up': 'Subir a escada',
  'claudeProfiles.picker.endBoundary': 'Fim: limite da escada',
  'claudeProfiles.picker.endPrefix': 'Terminar em',
  'claudeProfiles.globalTitle': 'Padrão global (tarefas sem perfil)',
  'claudeProfiles.globalDesc':
    'Tarefas que não escolhem seu próprio perfil usam este fallback. Desligado = executam com o modelo padrão do app.',
  'claudeProfiles.globalEnable': 'Ativar fallback padrão global',
  'claudeProfiles.globalStart': 'Modelo inicial…',
  'claudeProfiles.globalNoLadder': 'Adicione um perfil primeiro para construir a escada.',
  'claudeProfiles.globalSentStart': 'Começar em',
  'claudeProfiles.globalSentStep': 'e avançar',
  'claudeProfiles.globalSentDown': 'para baixo',
