...
const messages: TranslationMap = {
  ...
  'topics.tab': 'Argomenti',
  'topics.title': 'Thread di argomenti',
  'topics.subtitle': 'Aggrega contenuti da più fonti in una cronologia per argomento.',
  'topics.new': '+ Nuovo argomento',
  'topics.newTitle': 'Nuovo argomento',
  'topics.editTitle': 'Modifica argomento',
  'topics.loading': 'Caricamento…',
  'topics.emptyTitle': 'Nessun argomento',
  'topics.emptyDesc':
    'Crea un argomento per aggregare automaticamente email, chat e riunioni correlate.',
  'topics.chip.keywords': 'parole chiave',
  'topics.chip.sources': 'fonti',
  'topics.chip.entities': 'persone',
  'topics.field.name': 'Nome',
  'topics.field.namePlaceholder': 'es. Progetto Phoenix Q3',
  'topics.field.description': 'Descrizione',
  'topics.field.descriptionPlaceholder': 'Cosa copre questo argomento…',
  'topics.field.keywordLogic': 'Corrispondenza parole chiave',
  'topics.logic.or': 'Qualsiasi parola (O)',
  'topics.logic.and': 'Tutte le parole (E)',
  'topics.field.keywords': 'Parole chiave',
  'topics.field.keywordsPlaceholder': 'Digita una parola, premi Invio',
  'topics.field.sources': 'Fonti fissate',
  'topics.field.noSources': 'Nessuna fonte di memoria configurata.',
  'topics.field.entities': 'Persone / entità fissate',
  'topics.field.entitiesPlaceholder': 'es. person:jane-doe, premi Invio',
  'topics.timeline': 'Cronologia',
  'topics.timelineEmpty':
    'Nessun contenuto aggregato — in attesa della prossima sincronizzazione/riepilogo.',
  'topics.current': 'Attuale',
  'topics.save': 'Salva',
  'topics.saving': 'Salvataggio…',
  'topics.cancel': 'Annulla',
  'topics.delete': 'Elimina argomento',
  'topics.confirmDelete': 'Eliminare questo argomento? I riepiloghi aggregati vengono mantenuti.',
  'topics.err.nameRequired': 'Il nome è obbligatorio.',
  'topics.chip.conversations': 'chat',
  'topics.chip.people': 'persone',
  'topics.field.conversations': 'Chat di Teams',
  'topics.field.noConversations':
    'Ancora nessuna chat di Teams — sincronizza prima i messaggi di Teams.',
  'topics.field.searchConversations': 'Cerca chat per nome…',
  'topics.field.people': 'Persone',
  'topics.field.noPeople': 'Ancora nessuna persona — sincronizza prima email o Teams.',
  'topics.field.searchPeople': 'Cerca persone per nome o email…',
  'topics.field.pasteLink': 'Incolla un link a una chat di Teams…',
  'topics.field.addLink': 'Aggiungi',
  'topics.field.resolving': 'Risoluzione…',
  'topics.chip.meetings': 'riunioni',
  'topics.field.meetings': 'Riunioni',
  'topics.field.meetingsPlaceholder': 'Digita un nome di riunione o parte, premi Invio',
  'topics.field.noMeetings':
    'Ancora nessuna riunione — sincronizza prima le trascrizioni di Teams.',
  'topics.field.searchMeetings': 'Cerca riunioni per nome…',
  'topics.field.backfill': 'Riempi cronologia',
  'topics.backfill.none': 'Nessuno',
  'topics.backfill.label': 'Riempi:',
  'topics.backfill.done': 'Riempimento in coda — la cronologia si aggiorna a breve.',
  // Claude settings profiles
  'claudeProfiles.title': 'Profili Claude',
  'claudeProfiles.menuDesc': 'Registra i file settings.json di Claude Code e i loro modelli',
  'claudeProfiles.desktopOnly': 'Disponibile solo su desktop.',
  'claudeProfiles.intro':
    'Registra i tuoi file settings.json di Claude Code. Le attività possono scegliere un profilo e un modello; l’esecuzione IA parte con claude --settings <percorso>. I token di autenticazione nei file non vengono mai letti né mostrati.',
  'claudeProfiles.registered': 'Profili registrati',
  'claudeProfiles.loading': 'Caricamento…',
  'claudeProfiles.empty': 'Ancora nessun profilo.',
  'claudeProfiles.unreadable': 'file illeggibile',
  'claudeProfiles.remove': 'Rimuovi',
  'claudeProfiles.addTitle': 'Aggiungi profilo',
  'claudeProfiles.addDesc':
    'Indica un file settings.json, ad es. ~/.claude/settings.json.hyperspace',
  'claudeProfiles.nameLabel': 'Nome',
  'claudeProfiles.namePlaceholder': 'ad es. Hyperspace',
  'claudeProfiles.pathLabel': 'Percorso del file settings',
  'claudeProfiles.adding': 'Aggiunta…',
  'claudeProfiles.add': 'Aggiungi profilo',
  'claudeProfiles.picker.none': 'Ancora nessun profilo Claude: aggiungine uno nelle Impostazioni.',
  'claudeProfiles.picker.default': 'Predefinito (nessun profilo)',
  'claudeProfiles.picker.modelDefault': 'Modello predefinito',
  'claudeProfiles.parsing': 'Analisi…',
  'claudeProfiles.previewUnreadable': 'File non trovato o illeggibile.',
  'claudeProfiles.previewNoModels': 'Nessuna chiave di modello trovata in questo file.',
  'claudeProfiles.ladderTitle': 'Scala di fallback',
  'claudeProfiles.ladderDesc':
    "Ordine globale dei modelli usato dal fallback delle attività. Un'attività ripiega lungo questa scala (su o giù) quando il suo modello non si avvia.",
  'claudeProfiles.ladderEmpty': 'Aggiungi un profilo per costruire la scala.',
  'claudeProfiles.picker.fallback': "Ripiego se l'avvio fallisce",
  'claudeProfiles.picker.down': 'Scendi la scala',
  'claudeProfiles.picker.up': 'Sali la scala',
  'claudeProfiles.picker.endBoundary': 'Fine: limite della scala',
  'claudeProfiles.picker.endPrefix': 'Termina a',
  'claudeProfiles.globalTitle': 'Predefinito globale (attività senza profilo)',
  'claudeProfiles.globalDesc':
    'Le attività che non scelgono un profilo usano questo ripiego. Off = vengono eseguite con il modello predefinito dell’app.',
  'claudeProfiles.globalEnable': 'Attiva ripiego predefinito globale',
  'claudeProfiles.globalStart': 'Modello iniziale…',
  'claudeProfiles.globalNoLadder': 'Aggiungi prima un profilo per costruire la scala.',
  'claudeProfiles.globalSentStart': 'Inizia da',
  'claudeProfiles.globalSentStep': 'e procedi',
  'claudeProfiles.globalSentDown': 'giù',
