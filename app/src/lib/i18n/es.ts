...
const messages: TranslationMap = {
  ...
  'sap.systems.hint': 'Tokens are extracted from your open Outlook/Teams browser tabs.',
  ...
  'topics.tab': 'Temas',
  'topics.title': 'Hilos de temas',
  'topics.subtitle': 'Agrupa contenido de varias fuentes en una línea de tiempo por tema.',
  'topics.new': '+ Nuevo tema',
  'topics.newTitle': 'Nuevo tema',
  'topics.editTitle': 'Editar tema',
  'topics.loading': 'Cargando…',
  'topics.emptyTitle': 'Aún no hay temas',
  'topics.emptyDesc':
    'Crea un tema para agrupar automáticamente correos, chats y reuniones relacionados.',
  'topics.chip.keywords': 'palabras clave',
  'topics.chip.sources': 'fuentes',
  'topics.chip.entities': 'personas',
  'topics.field.name': 'Nombre',
  'topics.field.namePlaceholder': 'p. ej. Proyecto Phoenix T3',
  'topics.field.description': 'Descripción',
  'topics.field.descriptionPlaceholder': 'Qué abarca este tema…',
  'topics.field.keywordLogic': 'Coincidencia de palabras clave',
  'topics.logic.or': 'Cualquier palabra (O)',
  'topics.logic.and': 'Todas las palabras (Y)',
  'topics.field.keywords': 'Palabras clave',
  'topics.field.keywordsPlaceholder': 'Escribe una palabra y pulsa Enter',
  'topics.field.sources': 'Fuentes fijadas',
  'topics.field.noSources': 'No hay fuentes de memoria configuradas.',
  'topics.field.entities': 'Personas / entidades fijadas',
  'topics.field.entitiesPlaceholder': 'p. ej. person:jane-doe, pulsa Enter',
  'topics.timeline': 'Línea de tiempo',
  'topics.timelineEmpty':
    'Aún no se ha agrupado contenido — esperando la próxima sincronización/resumen.',
  'topics.current': 'Actual',
  'topics.save': 'Guardar',
  'topics.saving': 'Guardando…',
  'topics.cancel': 'Cancelar',
  'topics.delete': 'Eliminar tema',
  'topics.confirmDelete': '¿Eliminar este tema? Los resúmenes agrupados se conservan.',
  'topics.err.nameRequired': 'El nombre es obligatorio.',
  'topics.chip.conversations': 'chats',
  'topics.chip.people': 'personas',
  'topics.field.conversations': 'Chats de Teams',
  'topics.field.noConversations':
    'Aún no hay chats de Teams — sincroniza Mensajes de Teams primero.',
  'topics.field.searchConversations': 'Buscar chats por nombre…',
  'topics.field.people': 'Personas',
  'topics.field.noPeople': 'Aún no hay personas — sincroniza correo o Teams primero.',
  'topics.field.searchPeople': 'Buscar personas por nombre o correo…',
  'topics.field.pasteLink': 'Pega un enlace de chat de Teams…',
  'topics.field.addLink': 'Añadir',
  'topics.field.resolving': 'Resolviendo…',
  'topics.chip.meetings': 'reuniones',
  'topics.field.meetings': 'Reuniones',
  'topics.field.meetingsPlaceholder': 'Escribe un nombre de reunión o parte y pulsa Enter',
  'topics.field.noMeetings': 'Aún no hay reuniones — sincroniza transcripciones de Teams primero.',
  'topics.field.searchMeetings': 'Buscar reuniones por nombre…',
  'topics.field.backfill': 'Rellenar historial',
  'topics.backfill.none': 'Ninguno',
  'topics.backfill.label': 'Rellenar:',
  'topics.backfill.done': 'Relleno en cola — la línea de tiempo se actualizará pronto.',
  // Claude settings profiles
  'claudeProfiles.title': 'Perfiles de Claude',
  'claudeProfiles.menuDesc': 'Registra archivos settings.json de Claude Code y sus modelos',
  'claudeProfiles.desktopOnly': 'Disponible solo en escritorio.',
  'claudeProfiles.intro':
    'Registra tus archivos settings.json de Claude Code. Las tareas pueden elegir un perfil y modelo; la ejecución de IA se inicia con claude --settings <ruta>. Los tokens de autenticación nunca se leen ni se muestran.',
  'claudeProfiles.registered': 'Perfiles registrados',
  'claudeProfiles.loading': 'Cargando…',
  'claudeProfiles.empty': 'Aún no hay perfiles.',
  'claudeProfiles.unreadable': 'archivo ilegible',
  'claudeProfiles.remove': 'Eliminar',
  'claudeProfiles.addTitle': 'Agregar un perfil',
  'claudeProfiles.addDesc':
    'Apunta a un archivo settings.json, p. ej. ~/.claude/settings.json.hyperspace',
  'claudeProfiles.nameLabel': 'Nombre',
  'claudeProfiles.namePlaceholder': 'p. ej. Hyperspace',
  'claudeProfiles.pathLabel': 'Ruta del archivo settings',
  'claudeProfiles.adding': 'Agregando…',
  'claudeProfiles.add': 'Agregar perfil',
  'claudeProfiles.picker.none': 'Aún no hay perfiles de Claude: agrega uno en Ajustes.',
  'claudeProfiles.picker.default': 'Predeterminado (sin perfil)',
  'claudeProfiles.picker.modelDefault': 'Modelo predeterminado',
  'claudeProfiles.parsing': 'Analizando…',
  'claudeProfiles.previewUnreadable': 'Archivo no encontrado o ilegible.',
  'claudeProfiles.previewNoModels': 'No se encontraron claves de modelo en este archivo.',
  'claudeProfiles.ladderTitle': 'Escalera de reserva',
  'claudeProfiles.ladderDesc':
    'Orden global de modelos usado por el fallback de tareas. Una tarea recurre a esta escalera (arriba o abajo) cuando su modelo no arranca.',
  'claudeProfiles.ladderEmpty': 'Agrega un perfil para construir la escalera.',
  'claudeProfiles.picker.fallback': 'Reserva si falla el arranque',
  'claudeProfiles.picker.down': 'Bajar por la escalera',
  'claudeProfiles.picker.up': 'Subir por la escalera',
  'claudeProfiles.picker.endBoundary': 'Fin: límite de la escalera',
  'claudeProfiles.picker.endPrefix': 'Terminar en',
  'claudeProfiles.globalTitle': 'Predeterminado global (tareas sin perfil)',
  'claudeProfiles.globalDesc':
    'Las tareas que no eligen su propio perfil usan esta reserva. Apagado = se ejecutan con el modelo predeterminado de la app.',
  'claudeProfiles.globalEnable': 'Activar reserva predeterminada global',
  'claudeProfiles.globalStart': 'Modelo inicial…',
  'claudeProfiles.globalNoLadder': 'Agrega un perfil primero para construir la escalera.',
  'claudeProfiles.globalSentStart': 'Empezar en',
  'claudeProfiles.globalSentStep': 'y avanzar',
  'claudeProfiles.globalSentDown': 'hacia abajo',
  'claudeProfiles.globalSentUp': 'hacia arriba',
  'claudeProfiles.globalSentEnd': 'la escalera, terminando en',
  'claudeProfiles.globalSentBoundary': 'el límite de la escalera',
  'claudeProfiles.picker.defaultGlobal': 'Predeterminado — reserva global',
  'claudeProfiles.picker.defaultGlobalHint':
    'Sin perfil → se ejecuta con la reserva predeterminada global (configurada en Ajustes → Claude profiles).',
  'claudeProfiles.picker.defaultAppHint':
    'Sin perfil → se ejecuta con el modelo predeterminado de la app.',
  'claudeProfiles.throttleTitle': 'Límites de concurrencia',
  'claudeProfiles.throttleDesc':
    'Máx. de tareas de IA que pueden ejecutarse a la vez por modelo. Vacío = sin límite. Las tareas extra esperan en To Do (mayor prioridad primero) hasta que se libere un espacio.',
  'claudeProfiles.throttleEmpty': 'Agrega un perfil para establecer límites.',
  'claudeProfiles.throttleUnlimited': '∞',
  'claudeProfiles.throttleParallel': 'en paralelo',
};
