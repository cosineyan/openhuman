...
const messages: TranslationMap = {
  ...
  'memoryTree.status.embeddingProgressTitle': '向量化进度',
  'memoryTree.status.embeddingRefresh': '↻ 刷新',
  'memoryTree.status.embeddedCount': '已向量化: {count}',
  'memoryTree.status.pendingCount': '待处理: {count}',
  'memoryTree.status.embeddingComplete': '✓ 完成',
  'memoryTree.status.extractionJobs': '实体提取: ready {ready} · running {running}',
  ...
  'sap.systems.hint':
    'Token 从 Chrome 中已打开的 Outlook/Teams 标签页提取。点击连接前请确保已登录 Outlook Web。如果 Token 已过期，连接过程会自动刷新 Outlook 标签页。',
  ...
  'topics.tab': '主题',
  'topics.title': '主题线程',
  'topics.subtitle': '将多个来源的内容汇聚成一条主题时间线。',
  'topics.new': '+ 新建主题',
  'topics.newTitle': '新建主题',
  'topics.editTitle': '编辑主题',
  'topics.loading': '加载中…',
  'topics.emptyTitle': '暂无主题',
  'topics.emptyDesc': '创建主题以自动汇聚相关的邮件、聊天和会议。',
  'topics.chip.keywords': '关键词',
  'topics.chip.sources': '来源',
  'topics.chip.entities': '人员',
  'topics.field.name': '名称',
  'topics.field.namePlaceholder': '例如：Phoenix 项目 Q3',
  'topics.field.description': '描述',
  'topics.field.descriptionPlaceholder': '该主题涵盖的内容……',
  'topics.field.keywordLogic': '关键词匹配',
  'topics.logic.or': '任意关键词（OR）',
  'topics.logic.and': '全部关键词（AND）',
  'topics.field.keywords': '关键词',
  'topics.field.keywordsPlaceholder': '输入关键词，按回车',
  'topics.field.sources': '固定来源',
  'topics.field.noSources': '未配置任何记忆来源。',
  'topics.field.entities': '固定人员 / 实体',
  'topics.field.entitiesPlaceholder': '例如 person:jane-doe，按回车',
  'topics.timeline': '时间线',
  'topics.timelineEmpty': '尚未汇聚任何内容——等待下次同步/生成摘要。',
  'topics.current': '当前',
  'topics.save': '保存',
  'topics.saving': '保存中…',
  'topics.cancel': '取消',
  'topics.delete': '删除主题',
  'topics.confirmDelete': '删除此主题？已汇聚的摘要会保留。',
  'topics.err.nameRequired': '名称为必填项。',
  'topics.chip.conversations': '会话',
  'topics.chip.people': '人员',
  'topics.field.conversations': 'Teams 会话',
  'topics.field.noConversations': '还没有 Teams 会话——请先同步 Teams 消息。',
  'topics.field.searchConversations': '按名字搜索会话…',
  'topics.field.people': '人员',
  'topics.field.noPeople': '还没有人员——请先同步邮件或 Teams。',
  'topics.field.searchPeople': '按名字或邮箱搜索人员…',
  'topics.field.pasteLink': '粘贴 Teams 会话链接…',
  'topics.field.addLink': '添加',
  'topics.field.resolving': '解析中…',
  'topics.chip.meetings': '会议',
  'topics.field.meetings': '会议',
  'topics.field.meetingsPlaceholder': '输入会议名或片段，按回车',
  'topics.field.noMeetings': '还没有会议——请先同步 Teams 会议记录。',
  'topics.field.searchMeetings': '按名字搜索会议…',
  'topics.field.backfill': '回填历史',
  'topics.backfill.none': '不回填',
  'topics.backfill.label': '回填：',
  'topics.backfill.done': '回填已排队——时间线稍后更新。',
  // Claude settings profiles
  'claudeProfiles.title': 'Claude 配置',
  'claudeProfiles.menuDesc': '登记 Claude Code 的 settings.json 文件及其模型',
  'claudeProfiles.desktopOnly': '仅桌面端可用。',
  'claudeProfiles.intro':
    '登记你的 Claude Code settings.json 文件。任务可选择配置和模型；AI 运行时用 claude --settings <路径> 启动。文件中的鉴权令牌从不被读取或显示。',
  'claudeProfiles.registered': '已登记的配置',
  'claudeProfiles.loading': '加载中…',
  'claudeProfiles.empty': '还没有配置。',
  'claudeProfiles.unreadable': '文件不可读',
  'claudeProfiles.remove': '移除',
  'claudeProfiles.addTitle': '添加配置',
  'claudeProfiles.addDesc': '指向一个 settings.json 文件，例如 ~/.claude/settings.json.hyperspace',
  'claudeProfiles.nameLabel': '名称',
  'claudeProfiles.namePlaceholder': '例如 Hyperspace',
  'claudeProfiles.pathLabel': 'settings 文件路径',
  'claudeProfiles.adding': '添加中…',
  'claudeProfiles.add': '添加配置',
  'claudeProfiles.picker.none': '还没有 Claude 配置——请在设置中添加。',
  'claudeProfiles.picker.default': '默认（无配置）',
  'claudeProfiles.picker.modelDefault': '默认模型',
  'claudeProfiles.parsing': '解析中…',
  'claudeProfiles.previewUnreadable': '文件未找到或不可读。',
  'claudeProfiles.previewNoModels': '此文件中未找到模型键。',
  'claudeProfiles.ladderTitle': '降级梯子',
  'claudeProfiles.ladderDesc':
    '任务降级使用的全局模型顺序。当任务的模型启动失败时，会沿此梯子（向上或向下）降级。',
  'claudeProfiles.ladderEmpty': '添加配置以构建梯子。',
  'claudeProfiles.picker.fallback': '启动失败时降级',
  'claudeProfiles.picker.down': '沿梯向下',
  'claudeProfiles.picker.up': '沿梯向上',
  'claudeProfiles.picker.endBoundary': '终点：梯子边界',
  'claudeProfiles.picker.endPrefix': '终点',
  'claudeProfiles.globalTitle': '全局默认（未配置 profile 的 task）',
  'claudeProfiles.globalDesc':
    '没有自己选 profile 的 task 使用此降级策略。关闭 = 用 app 默认模型运行。',
  'claudeProfiles.globalEnable': '启用全局默认降级',
  'claudeProfiles.globalStart': '起点模型…',
  'claudeProfiles.globalNoLadder': '请先添加 profile 以构建梯子。',
  'claudeProfiles.globalSentStart': '起点',
  'claudeProfiles.globalSentStep': '，沿梯',
  'claudeProfiles.globalSentDown': '向下',
