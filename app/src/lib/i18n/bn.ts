...
const messages: TranslationMap = {
  ...
  'topics.tab': 'বিষয়',
  'topics.title': 'বিষয় থ্রেড',
  'topics.subtitle': 'একাধিক উৎস থেকে বিষয়ভিত্তিক টাইমলাইনে কনটেন্ট একত্র করুন।',
  'topics.new': '+ নতুন বিষয়',
  'topics.newTitle': 'নতুন বিষয়',
  'topics.editTitle': 'বিষয় সম্পাদনা',
  'topics.loading': 'লোড হচ্ছে…',
  'topics.emptyTitle': 'এখনও কোনো বিষয় নেই',
  'topics.emptyDesc':
    'সম্পর্কিত ইমেল, চ্যাট ও মিটিং স্বয়ংক্রিয়ভাবে একত্র করতে একটি বিষয় তৈরি করুন।',
  'topics.chip.keywords': 'কীওয়ার্ড',
  'topics.chip.sources': 'উৎস',
  'topics.chip.entities': 'ব্যক্তি',
  'topics.field.name': 'নাম',
  'topics.field.namePlaceholder': 'যেমন প্রজেক্ট ফিনিক্স Q3',
  'topics.field.description': 'বিবরণ',
  'topics.field.descriptionPlaceholder': 'এই বিষয় কী কভার করে…',
  'topics.field.keywordLogic': 'কীওয়ার্ড ম্যাচ',
  'topics.logic.or': 'যেকোনো কীওয়ার্ড (OR)',
  'topics.logic.and': 'সব কীওয়ার্ড (AND)',
  'topics.field.keywords': 'কীওয়ার্ড',
  'topics.field.keywordsPlaceholder': 'একটি কীওয়ার্ড লিখে Enter চাপুন',
  'topics.field.sources': 'পিন করা উৎস',
  'topics.field.noSources': 'কোনো মেমরি উৎস কনফিগার করা নেই।',
  'topics.field.entities': 'পিন করা ব্যক্তি / এনটিটি',
  'topics.field.entitiesPlaceholder': 'যেমন person:jane-doe, Enter চাপুন',
  'topics.timeline': 'টাইমলাইন',
  'topics.timelineEmpty': 'এখনও কোনো কনটেন্ট একত্র হয়নি — পরবর্তী সিঙ্ক/সারাংশের অপেক্ষায়।',
  'topics.current': 'বর্তমান',
  'topics.save': 'সংরক্ষণ',
  'topics.saving': 'সংরক্ষণ হচ্ছে…',
  'topics.cancel': 'বাতিল',
  'topics.delete': 'বিষয় মুছুন',
  'topics.confirmDelete': 'এই বিষয় মুছবেন? একত্রিত সারাংশগুলো থাকবে।',
  'topics.err.nameRequired': 'নাম আবশ্যক।',
  'topics.chip.conversations': 'চ্যাট',
  'topics.chip.people': 'ব্যক্তি',
  'topics.field.conversations': 'Teams চ্যাট',
  'topics.field.noConversations': 'এখনও কোনো Teams চ্যাট নেই — আগে Teams বার্তা সিঙ্ক করুন।',
  'topics.field.searchConversations': 'নাম দিয়ে চ্যাট খুঁজুন…',
  'topics.field.people': 'ব্যক্তি',
  'topics.field.noPeople': 'এখনও কোনো ব্যক্তি নেই — আগে ইমেল বা Teams সিঙ্ক করুন।',
  'topics.field.searchPeople': 'নাম বা ইমেল দিয়ে ব্যক্তি খুঁজুন…',
  'topics.field.pasteLink': 'একটি Teams চ্যাট লিঙ্ক পেস্ট করুন…',
  'topics.field.addLink': 'যোগ করুন',
  'topics.field.resolving': 'সমাধান হচ্ছে…',
  'topics.chip.meetings': 'মিটিং',
  'topics.field.meetings': 'মিটিং',
  'topics.field.meetingsPlaceholder': 'মিটিংয়ের নাম বা অংশ লিখে Enter চাপুন',
  'topics.field.noMeetings': 'এখনও কোনো মিটিং নেই — আগে Teams ট্রান্সক্রিপ্ট সিঙ্ক করুন।',
  'topics.field.searchMeetings': 'নাম দিয়ে মিটিং খুঁজুন…',
  'topics.field.backfill': 'ইতিহাস পূরণ',
  'topics.backfill.none': 'কিছু না',
  'topics.backfill.label': 'পূরণ:',
  'topics.backfill.done': 'পূরণ সারিবদ্ধ — টাইমলাইন শীঘ্রই আপডেট হবে।',
  // Claude settings profiles
  'claudeProfiles.title': 'Claude প্রোফাইল',
  'claudeProfiles.menuDesc': 'Claude Code settings.json ফাইল ও তাদের মডেল নিবন্ধন করুন',
  'claudeProfiles.desktopOnly': 'শুধু ডেস্কটপে উপলব্ধ।',
  'claudeProfiles.intro':
    'আপনার Claude Code settings.json ফাইল নিবন্ধন করুন। টাস্ক একটি প্রোফাইল ও মডেল বেছে নিতে পারে; AI রান claude --settings <path> দিয়ে চালু হয়। ফাইলের টোকেন কখনও পড়া বা দেখানো হয় না।',
  'claudeProfiles.registered': 'নিবন্ধিত প্রোফাইল',
  'claudeProfiles.loading': 'লোড হচ্ছে…',
  'claudeProfiles.empty': 'এখনও কোনো প্রোফাইল নেই।',
  'claudeProfiles.unreadable': 'ফাইল পড়া যাচ্ছে না',
  'claudeProfiles.remove': 'সরান',
  'claudeProfiles.addTitle': 'একটি প্রোফাইল যোগ করুন',
  'claudeProfiles.addDesc':
    'একটি settings.json ফাইল নির্দেশ করুন, যেমন ~/.claude/settings.json.hyperspace',
  'claudeProfiles.nameLabel': 'নাম',
  'claudeProfiles.namePlaceholder': 'যেমন Hyperspace',
  'claudeProfiles.pathLabel': 'settings ফাইলের পাথ',
  'claudeProfiles.adding': 'যোগ করা হচ্ছে…',
  'claudeProfiles.add': 'প্রোফাইল যোগ করুন',
  'claudeProfiles.picker.none': 'এখনও কোনো Claude প্রোফাইল নেই — সেটিংসে যোগ করুন।',
  'claudeProfiles.picker.default': 'ডিফল্ট (কোনো প্রোফাইল নেই)',
  'claudeProfiles.picker.modelDefault': 'ডিফল্ট মডেল',
  'claudeProfiles.parsing': 'বিশ্লেষণ হচ্ছে…',
  'claudeProfiles.previewUnreadable': 'ফাইল পাওয়া যায়নি বা পড়া যাচ্ছে না।',
  'claudeProfiles.previewNoModels': 'এই ফাইলে কোনো মডেল কী পাওয়া যায়নি।',
  'claudeProfiles.ladderTitle': 'ফলব্যাক ল্যাডার',
  'claudeProfiles.ladderDesc':
    'টাস্ক ফলব্যাকে ব্যবহৃত গ্লোবাল মডেল ক্রম। মডেল চালু না হলে টাস্ক এই ল্যাডার বরাবর (উপরে বা নিচে) ফলব্যাক করে।',
  'claudeProfiles.ladderEmpty': 'ল্যাডার তৈরি করতে একটি প্রোফাইল যোগ করুন।',
  'claudeProfiles.picker.fallback': 'চালু ব্যর্থ হলে ফলব্যাক',
  'claudeProfiles.picker.down': 'ল্যাডার নিচে',
  'claudeProfiles.picker.up': 'ল্যাডার উপরে',
  'claudeProfiles.picker.endBoundary': 'শেষ: ল্যাডার সীমা',
  'claudeProfiles.picker.endPrefix': 'শেষ',
  'claudeProfiles.globalTitle': 'গ্লোবাল ডিফল্ট (প্রোফাইলবিহীন টাস্ক)',
  'claudeProfiles.globalDesc':
    'যেসব টাস্ক নিজের প্রোফাইল বেছে নেয় না তারা এই ফলব্যাক ব্যবহার করে। বন্ধ = অ্যাপ ডিফল্ট মডেলে চলে।',
  'claudeProfiles.globalEnable': 'গ্লোবাল ডিফল্ট ফলব্যাক সক্রিয় করুন',
  'claudeProfiles.globalStart': 'শুরুর মডেল…',
  'claudeProfiles.globalNoLadder': 'ল্যাডার তৈরি করতে আগে একটি প্রোফাইল যোগ করুন।',
  'claudeProfiles.globalSentStart': 'শুরু',
  'claudeProfiles.globalSentStep': 'এবং যান',
  'claudeProfiles.globalSentDown': 'নিচে',
