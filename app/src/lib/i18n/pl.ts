...
const messages: TranslationMap = {
  ...
  'topics.tab': 'Tematy',
  'topics.title': 'Wątki tematyczne',
  'topics.subtitle': 'Zbieraj treści z wielu źródeł w oś czasu tematu.',
  'topics.new': '+ Nowy temat',
  'topics.newTitle': 'Nowy temat',
  'topics.editTitle': 'Edytuj temat',
  'topics.loading': 'Ładowanie…',
  'topics.emptyTitle': 'Brak tematów',
  'topics.emptyDesc':
    'Utwórz temat, aby automatycznie zbierać powiązane e-maile, czaty i spotkania.',
  'topics.chip.keywords': 'słowa kluczowe',
  'topics.chip.sources': 'źródła',
  'topics.chip.entities': 'osoby',
  'topics.field.name': 'Nazwa',
  'topics.field.namePlaceholder': 'np. Projekt Phoenix Q3',
  'topics.field.description': 'Opis',
  'topics.field.descriptionPlaceholder': 'Czego dotyczy ten temat…',
  'topics.field.keywordLogic': 'Dopasowanie słów kluczowych',
  'topics.logic.or': 'Dowolne słowo (LUB)',
  'topics.logic.and': 'Wszystkie słowa (I)',
  'topics.field.keywords': 'Słowa kluczowe',
  'topics.field.keywordsPlaceholder': 'Wpisz słowo, naciśnij Enter',
  'topics.field.sources': 'Przypięte źródła',
  'topics.field.noSources': 'Brak skonfigurowanych źródeł pamięci.',
  'topics.field.entities': 'Przypięte osoby / encje',
  'topics.field.entitiesPlaceholder': 'np. person:jane-doe, naciśnij Enter',
  'topics.timeline': 'Oś czasu',
  'topics.timelineEmpty':
    'Nie zebrano jeszcze treści — oczekiwanie na następną synchronizację/podsumowanie.',
  'topics.current': 'Bieżące',
  'topics.save': 'Zapisz',
  'topics.saving': 'Zapisywanie…',
  'topics.cancel': 'Anuluj',
  'topics.delete': 'Usuń temat',
  'topics.confirmDelete': 'Usunąć ten temat? Zebrane podsumowania zostaną zachowane.',
  'topics.err.nameRequired': 'Nazwa jest wymagana.',
  'topics.chip.conversations': 'czaty',
  'topics.chip.people': 'osoby',
  'topics.field.conversations': 'Czaty Teams',
  'topics.field.noConversations': 'Brak czatów Teams — najpierw zsynchronizuj wiadomości Teams.',
  'topics.field.searchConversations': 'Szukaj czatów po nazwie…',
  'topics.field.people': 'Osoby',
  'topics.field.noPeople': 'Brak osób — najpierw zsynchronizuj e-mail lub Teams.',
  'topics.field.searchPeople': 'Szukaj osób po nazwie lub e-mailu…',
  'topics.field.pasteLink': 'Wklej link do czatu Teams…',
  'topics.field.addLink': 'Dodaj',
  'topics.field.resolving': 'Rozwiązywanie…',
  'topics.chip.meetings': 'spotkania',
  'topics.field.meetings': 'Spotkania',
  'topics.field.meetingsPlaceholder': 'Wpisz nazwę spotkania lub jej część, naciśnij Enter',
  'topics.field.noMeetings': 'Brak spotkań — najpierw zsynchronizuj transkrypcje Teams.',
  'topics.field.searchMeetings': 'Szukaj spotkań po nazwie…',
  'topics.field.backfill': 'Uzupełnij historię',
  'topics.backfill.none': 'Brak',
  'topics.backfill.label': 'Uzupełnij:',
  'topics.backfill.done': 'Uzupełnianie w kolejce — oś czasu wkrótce się zaktualizuje.',
  // Claude settings profiles
  'claudeProfiles.title': 'Profile Claude',
  'claudeProfiles.menuDesc': 'Zarejestruj pliki settings.json Claude Code i ich modele',
  'claudeProfiles.desktopOnly': 'Dostępne tylko na komputerze.',
  'claudeProfiles.intro':
    'Zarejestruj swoje pliki settings.json Claude Code. Zadania mogą wybrać profil i model; uruchomienie AI startuje z claude --settings <ścieżka>. Tokeny uwierzytelniania w plikach nigdy nie są odczytywane ani wyświetlane.',
  'claudeProfiles.registered': 'Zarejestrowane profile',
  'claudeProfiles.loading': 'Ładowanie…',
  'claudeProfiles.empty': 'Brak profili.',
  'claudeProfiles.unreadable': 'plik nieczytelny',
  'claudeProfiles.remove': 'Usuń',
  'claudeProfiles.addTitle': 'Dodaj profil',
  'claudeProfiles.addDesc': 'Wskaż plik settings.json, np. ~/.claude/settings.json.hyperspace',
  'claudeProfiles.nameLabel': 'Nazwa',
  'claudeProfiles.namePlaceholder': 'np. Hyperspace',
  'claudeProfiles.pathLabel': 'Ścieżka pliku settings',
  'claudeProfiles.adding': 'Dodawanie…',
  'claudeProfiles.add': 'Dodaj profil',
  'claudeProfiles.picker.none': 'Brak profili Claude — dodaj w Ustawieniach.',
  'claudeProfiles.picker.default': 'Domyślny (bez profilu)',
  'claudeProfiles.picker.modelDefault': 'Model domyślny',
  'claudeProfiles.parsing': 'Analizowanie…',
  'claudeProfiles.previewUnreadable': 'Nie znaleziono pliku lub jest nieczytelny.',
  'claudeProfiles.previewNoModels': 'Nie znaleziono kluczy modeli w tym pliku.',
  'claudeProfiles.ladderTitle': 'Drabina awaryjna',
  'claudeProfiles.ladderDesc':
    'Globalna kolejność modeli używana przez awaryjne przełączanie zadań. Zadanie schodzi po tej drabinie (w górę lub w dół), gdy model nie wystartuje.',
  'claudeProfiles.ladderEmpty': 'Dodaj profil, aby zbudować drabinę.',
  'claudeProfiles.picker.fallback': 'Awaryjnie przy błędzie startu',
  'claudeProfiles.picker.down': 'W dół drabiny',
  'claudeProfiles.picker.up': 'W górę drabiny',
  'claudeProfiles.picker.endBoundary': 'Koniec: granica drabiny',
  'claudeProfiles.picker.endPrefix': 'Zakończ na',
  'claudeProfiles.globalTitle': 'Globalny domyślny (zadania bez profilu)',
  'claudeProfiles.globalDesc':
    'Zadania bez własnego profilu używają tego awaryjnego. Wył. = działają z domyślnym modelem aplikacji.',
  'claudeProfiles.globalEnable': 'Włącz globalny domyślny fallback',
  'claudeProfiles.globalStart': 'Model początkowy…',
  'claudeProfiles.globalNoLadder': 'Najpierw dodaj profil, aby zbudować drabinę.',
  'claudeProfiles.globalSentStart': 'Zacznij od',
  'claudeProfiles.globalSentStep': 'i przejdź',
  'claudeProfiles.globalSentDown': 'w dół',
