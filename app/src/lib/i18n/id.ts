...
const messages: TranslationMap = {
  ...
  'topics.tab': 'Topik',
  'topics.title': 'Utas Topik',
  'topics.subtitle': 'Gabungkan konten dari berbagai sumber ke dalam linimasa topik.',
  'topics.new': '+ Topik Baru',
  'topics.newTitle': 'Topik Baru',
  'topics.editTitle': 'Edit Topik',
  'topics.loading': 'Memuat…',
  'topics.emptyTitle': 'Belum ada topik',
  'topics.emptyDesc':
    'Buat topik untuk menggabungkan email, obrolan, dan rapat terkait secara otomatis.',
  'topics.chip.keywords': 'kata kunci',
  'topics.chip.sources': 'sumber',
  'topics.chip.entities': 'orang',
  'topics.field.name': 'Nama',
  'topics.field.namePlaceholder': 'mis. Proyek Phoenix Q3',
  'topics.field.description': 'Deskripsi',
  'topics.field.descriptionPlaceholder': 'Apa yang dicakup topik ini…',
  'topics.field.keywordLogic': 'Pencocokan kata kunci',
  'topics.logic.or': 'Kata kunci apa pun (ATAU)',
  'topics.logic.and': 'Semua kata kunci (DAN)',
  'topics.field.keywords': 'Kata kunci',
  'topics.field.keywordsPlaceholder': 'Ketik kata kunci, tekan Enter',
  'topics.field.sources': 'Sumber tersemat',
  'topics.field.noSources': 'Tidak ada sumber memori yang dikonfigurasi.',
  'topics.field.entities': 'Orang / entitas tersemat',
  'topics.field.entitiesPlaceholder': 'mis. person:jane-doe, tekan Enter',
  'topics.timeline': 'Linimasa',
  'topics.timelineEmpty':
    'Belum ada konten yang digabungkan — menunggu sinkronisasi/ringkasan berikutnya.',
  'topics.current': 'Saat ini',
  'topics.save': 'Simpan',
  'topics.saving': 'Menyimpan…',
  'topics.cancel': 'Batal',
  'topics.delete': 'Hapus topik',
  'topics.confirmDelete': 'Hapus topik ini? Ringkasan yang digabungkan tetap disimpan.',
  'topics.err.nameRequired': 'Nama wajib diisi.',
  'topics.chip.conversations': 'obrolan',
  'topics.chip.people': 'orang',
  'topics.field.conversations': 'Obrolan Teams',
  'topics.field.noConversations': 'Belum ada obrolan Teams — sinkronkan Pesan Teams dulu.',
  'topics.field.searchConversations': 'Cari obrolan berdasarkan nama…',
  'topics.field.people': 'Orang',
  'topics.field.noPeople': 'Belum ada orang — sinkronkan email atau Teams dulu.',
  'topics.field.searchPeople': 'Cari orang berdasarkan nama atau email…',
  'topics.field.pasteLink': 'Tempel tautan obrolan Teams…',
  'topics.field.addLink': 'Tambah',
  'topics.field.resolving': 'Menyelesaikan…',
  'topics.chip.meetings': 'rapat',
  'topics.field.meetings': 'Rapat',
  'topics.field.meetingsPlaceholder': 'Ketik nama rapat atau sebagian, tekan Enter',
  'topics.field.noMeetings': 'Belum ada rapat — sinkronkan transkrip Teams dulu.',
  'topics.field.searchMeetings': 'Cari rapat berdasarkan nama…',
  'topics.field.backfill': 'Isi riwayat',
  'topics.backfill.none': 'Tidak ada',
  'topics.backfill.label': 'Isi:',
  'topics.backfill.done': 'Pengisian diantrekan — linimasa segera diperbarui.',
  // Claude settings profiles
  'claudeProfiles.title': 'Profil Claude',
  'claudeProfiles.menuDesc': 'Daftarkan file settings.json Claude Code dan modelnya',
  'claudeProfiles.desktopOnly': 'Hanya tersedia di desktop.',
  'claudeProfiles.intro':
    'Daftarkan file settings.json Claude Code Anda. Tugas dapat memilih profil dan model; proses AI dimulai dengan claude --settings <path>. Token autentikasi di file tidak pernah dibaca atau ditampilkan.',
  'claudeProfiles.registered': 'Profil terdaftar',
  'claudeProfiles.loading': 'Memuat…',
  'claudeProfiles.empty': 'Belum ada profil.',
  'claudeProfiles.unreadable': 'file tidak terbaca',
  'claudeProfiles.remove': 'Hapus',
  'claudeProfiles.addTitle': 'Tambah profil',
  'claudeProfiles.addDesc':
    'Arahkan ke file settings.json, mis. ~/.claude/settings.json.hyperspace',
  'claudeProfiles.nameLabel': 'Nama',
  'claudeProfiles.namePlaceholder': 'mis. Hyperspace',
  'claudeProfiles.pathLabel': 'Path file settings',
  'claudeProfiles.adding': 'Menambahkan…',
  'claudeProfiles.add': 'Tambah profil',
  'claudeProfiles.picker.none': 'Belum ada profil Claude — tambahkan di Pengaturan.',
  'claudeProfiles.picker.default': 'Default (tanpa profil)',
  'claudeProfiles.picker.modelDefault': 'Model default',
  'claudeProfiles.parsing': 'Menganalisis…',
  'claudeProfiles.previewUnreadable': 'File tidak ditemukan atau tidak terbaca.',
  'claudeProfiles.previewNoModels': 'Tidak ada kunci model di file ini.',
  'claudeProfiles.ladderTitle': 'Tangga fallback',
  'claudeProfiles.ladderDesc':
    'Urutan model global yang dipakai fallback tugas. Tugas jatuh ke tangga ini (naik atau turun) saat modelnya gagal dijalankan.',
  'claudeProfiles.ladderEmpty': 'Tambahkan profil untuk membangun tangga.',
  'claudeProfiles.picker.fallback': 'Fallback saat gagal mulai',
  'claudeProfiles.picker.down': 'Turun tangga',
  'claudeProfiles.picker.up': 'Naik tangga',
  'claudeProfiles.picker.endBoundary': 'Akhir: batas tangga',
  'claudeProfiles.picker.endPrefix': 'Akhiri di',
  'claudeProfiles.globalTitle': 'Default global (tugas tanpa profil)',
  'claudeProfiles.globalDesc':
    'Tugas yang tidak memilih profil sendiri memakai fallback ini. Mati = berjalan dengan model default aplikasi.',
  'claudeProfiles.globalEnable': 'Aktifkan fallback default global',
  'claudeProfiles.globalStart': 'Model awal…',
  'claudeProfiles.globalNoLadder': 'Tambahkan profil dulu untuk membangun tangga.',
  'claudeProfiles.globalSentStart': 'Mulai dari',
  'claudeProfiles.globalSentStep': 'dan melangkah',
  'claudeProfiles.globalSentDown': 'ke bawah',
