...
const messages: TranslationMap = {
  ...
  'topics.tab': 'المواضيع',
  'topics.title': 'سلاسل المواضيع',
  'topics.subtitle': 'جمّع المحتوى من مصادر متعددة في خط زمني للموضوع.',
  'topics.new': '+ موضوع جديد',
  'topics.newTitle': 'موضوع جديد',
  'topics.editTitle': 'تعديل الموضوع',
  'topics.loading': 'جارٍ التحميل…',
  'topics.emptyTitle': 'لا مواضيع بعد',
  'topics.emptyDesc': 'أنشئ موضوعًا لتجميع الرسائل والمحادثات والاجتماعات ذات الصلة تلقائيًا.',
  'topics.chip.keywords': 'كلمات مفتاحية',
  'topics.chip.sources': 'مصادر',
  'topics.chip.entities': 'أشخاص',
  'topics.field.name': 'الاسم',
  'topics.field.namePlaceholder': 'مثال: مشروع فينيكس الربع الثالث',
  'topics.field.description': 'الوصف',
  'topics.field.descriptionPlaceholder': 'ما الذي يغطيه هذا الموضوع…',
  'topics.field.keywordLogic': 'مطابقة الكلمات المفتاحية',
  'topics.logic.or': 'أي كلمة (أو)',
  'topics.logic.and': 'كل الكلمات (و)',
  'topics.field.keywords': 'الكلمات المفتاحية',
  'topics.field.keywordsPlaceholder': 'اكتب كلمة واضغط Enter',
  'topics.field.sources': 'المصادر المثبّتة',
  'topics.field.noSources': 'لا توجد مصادر ذاكرة مُهيّأة.',
  'topics.field.entities': 'الأشخاص / الكيانات المثبّتة',
  'topics.field.entitiesPlaceholder': 'مثال: person:jane-doe، اضغط Enter',
  'topics.timeline': 'الخط الزمني',
  'topics.timelineEmpty': 'لم يُجمَّع أي محتوى بعد — بانتظار المزامنة/التلخيص التالي.',
  'topics.current': 'الحالي',
  'topics.save': 'حفظ',
  'topics.saving': 'جارٍ الحفظ…',
  'topics.cancel': 'إلغاء',
  'topics.delete': 'حذف الموضوع',
  'topics.confirmDelete': 'حذف هذا الموضوع؟ ستبقى الملخصات المجمّعة.',
  'topics.err.nameRequired': 'الاسم مطلوب.',
  'topics.chip.conversations': 'محادثات',
  'topics.chip.people': 'أشخاص',
  'topics.field.conversations': 'محادثات Teams',
  'topics.field.noConversations': 'لا توجد محادثات Teams بعد — زامن رسائل Teams أولاً.',
  'topics.field.searchConversations': 'ابحث في المحادثات بالاسم…',
  'topics.field.people': 'الأشخاص',
  'topics.field.noPeople': 'لا يوجد أشخاص بعد — زامن البريد أو Teams أولاً.',
  'topics.field.searchPeople': 'ابحث عن شخص بالاسم أو البريد…',
  'topics.field.pasteLink': 'الصق رابط محادثة Teams…',
  'topics.field.addLink': 'إضافة',
  'topics.field.resolving': 'جارٍ الحل…',
  'topics.chip.meetings': 'اجتماعات',
  'topics.field.meetings': 'الاجتماعات',
  'topics.field.meetingsPlaceholder': 'اكتب اسم اجتماع أو جزءًا منه واضغط Enter',
  'topics.field.noMeetings': 'لا توجد اجتماعات بعد — زامن نصوص Teams أولاً.',
  'topics.field.searchMeetings': 'ابحث عن اجتماع بالاسم…',
  'topics.field.backfill': 'ملء السجل',
  'topics.backfill.none': 'بدون',
  'topics.backfill.label': 'ملء:',
  'topics.backfill.done': 'تمت جدولة الملء — سيُحدَّث الخط الزمني قريبًا.',
  // Claude settings profiles
  'claudeProfiles.title': 'ملفات Claude',
  'claudeProfiles.menuDesc': 'سجّل ملفات settings.json الخاصة بـ Claude Code ونماذجها',
  'claudeProfiles.desktopOnly': 'متاح على سطح المكتب فقط.',
  'claudeProfiles.intro':
    'سجّل ملفات settings.json الخاصة بـ Claude Code. يمكن للمهام اختيار ملف ونموذج؛ يبدأ تشغيل الذكاء الاصطناعي بـ claude --settings <path>. لا تُقرأ رموز المصادقة في الملفات ولا تُعرض أبدًا.',
  'claudeProfiles.registered': 'الملفات المسجّلة',
  'claudeProfiles.loading': 'جارٍ التحميل…',
  'claudeProfiles.empty': 'لا توجد ملفات بعد.',
  'claudeProfiles.unreadable': 'الملف غير قابل للقراءة',
  'claudeProfiles.remove': 'إزالة',
  'claudeProfiles.addTitle': 'إضافة ملف',
  'claudeProfiles.addDesc': 'أشر إلى ملف settings.json، مثل ~/.claude/settings.json.hyperspace',
  'claudeProfiles.nameLabel': 'الاسم',
  'claudeProfiles.namePlaceholder': 'مثل Hyperspace',
  'claudeProfiles.pathLabel': 'مسار ملف settings',
  'claudeProfiles.adding': 'جارٍ الإضافة…',
  'claudeProfiles.add': 'إضافة ملف',
  'claudeProfiles.picker.none': 'لا توجد ملفات Claude بعد — أضف واحدًا من الإعدادات.',
  'claudeProfiles.picker.default': 'افتراضي (بدون ملف)',
  'claudeProfiles.picker.modelDefault': 'النموذج الافتراضي',
  'claudeProfiles.parsing': 'جارٍ التحليل…',
  'claudeProfiles.previewUnreadable': 'الملف غير موجود أو غير قابل للقراءة.',
  'claudeProfiles.previewNoModels': 'لم يتم العثور على مفاتيح نماذج في هذا الملف.',
  'claudeProfiles.ladderTitle': 'سلم الرجوع',
  'claudeProfiles.ladderDesc':
    'ترتيب النماذج العام المستخدم في رجوع المهام. تتراجع المهمة على هذا السلم (لأعلى أو لأسفل) عند فشل بدء نموذجها.',
  'claudeProfiles.ladderEmpty': 'أضف ملفًا لبناء السلم.',
  'claudeProfiles.picker.fallback': 'الرجوع عند فشل البدء',
  'claudeProfiles.picker.down': 'النزول في السلم',
  'claudeProfiles.picker.up': 'الصعود في السلم',
  'claudeProfiles.picker.endBoundary': 'النهاية: حدّ السلم',
  'claudeProfiles.picker.endPrefix': 'الانتهاء عند',
  'claudeProfiles.globalTitle': 'الافتراضي العام (المهام بلا ملف)',
  'claudeProfiles.globalDesc':
    'المهام التي لا تختار ملفها الخاص تستخدم هذا الرجوع. إيقاف = تعمل بالنموذج الافتراضي للتطبيق.',
  'claudeProfiles.globalEnable': 'تفعيل الرجوع الافتراضي العام',
  'claudeProfiles.globalStart': 'نموذج البداية…',
  'claudeProfiles.globalNoLadder': 'أضف ملفًا أولاً لبناء السلم.',
  'claudeProfiles.globalSentStart': 'ابدأ من',
  'claudeProfiles.globalSentStep': 'وتحرّك',
  'claudeProfiles.globalSentDown': 'لأسفل',
