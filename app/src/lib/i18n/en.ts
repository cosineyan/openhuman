...
const en: TranslationMap = {
  ...
  // Chat (additional)
  'chat.safetyTimeout':
    'No response from the agent after 5 minutes. Try again or check your connection.',
  ...
  'sap.systems.waitingLoginHint':
    'Please complete login in the Outlook tab that just opened in Chrome.',
  'sap.systems.hint':
  ...
  'sap.credentials.ahaDesc':
    'Enter your Aha! personal API token to enable AI access to sap.aha.io roadmap data.',
  ...
  'topics.tab': 'Topics',
  'topics.title': 'Topic Threads',
  'topics.subtitle': 'Aggregate content across sources into a topic timeline.',
  'topics.new': '+ New Topic',
  'topics.newTitle': 'New Topic',
  'topics.editTitle': 'Edit Topic',
  'topics.loading': 'Loading…',
  'topics.emptyTitle': 'No topics yet',
  'topics.emptyDesc': 'Create a topic to auto-aggregate related emails, chats, and meetings.',
  'topics.chip.keywords': 'keywords',
  'topics.chip.sources': 'sources',
  'topics.chip.entities': 'people',
  'topics.chip.conversations': 'chats',
  'topics.chip.people': 'people',
  'topics.chip.meetings': 'meetings',
  'topics.field.name': 'Name',
  'topics.field.namePlaceholder': 'e.g. Project Phoenix Q3',
  'topics.field.description': 'Description',
  'topics.field.descriptionPlaceholder': 'What this topic covers…',
  'topics.field.keywordLogic': 'Keyword match',
  'topics.logic.or': 'Any keyword (OR)',
  'topics.logic.and': 'All keywords (AND)',
  'topics.field.keywords': 'Keywords',
  'topics.field.keywordsPlaceholder': 'Type a keyword, press Enter',
  'topics.field.sources': 'Pinned sources',
  'topics.field.noSources': 'No memory sources configured.',
  'topics.field.entities': 'Pinned people / entities',
  'topics.field.entitiesPlaceholder': 'e.g. person:jane-doe, press Enter',
  'topics.field.conversations': 'Teams chats',
  'topics.field.noConversations': 'No Teams chats yet — sync Teams Messages first.',
  'topics.field.searchConversations': 'Search chats by name…',
  'topics.field.pasteLink': 'Paste a Teams chat link…',
  'topics.field.addLink': 'Add',
  'topics.field.resolving': 'Resolving…',
  'topics.field.people': 'People',
  'topics.field.noPeople': 'No people found yet — sync email or Teams first.',
  'topics.field.searchPeople': 'Search people by name or email…',
  'topics.field.meetings': 'Meetings',
  'topics.field.meetingsPlaceholder': 'Type a meeting name or part of it, press Enter',
  'topics.field.noMeetings': 'No meetings found yet — sync Teams transcripts first.',
  'topics.field.searchMeetings': 'Search meetings by name…',
  'topics.field.backfill': 'Backfill history',
  'topics.backfill.none': 'None',
  'topics.backfill.label': 'Backfill:',
  'topics.backfill.done': 'Backfill queued — timeline updates shortly.',
  'topics.timeline': 'Timeline',
  'topics.timelineEmpty': 'No content aggregated yet — waiting for the next sync / summary.',
  'topics.current': 'Current',
  'topics.save': 'Save',
  'topics.saving': 'Saving…',
  'topics.cancel': 'Cancel',
  'topics.delete': 'Delete topic',
  'topics.confirmDelete': 'Delete this topic? The aggregated summaries are kept.',
  'topics.err.nameRequired': 'Name is required.',
  // Claude settings profiles
  'claudeProfiles.title': 'Claude profiles',
  'claudeProfiles.menuDesc': 'Register Claude Code settings.json files and their models',
  'claudeProfiles.desktopOnly': 'Available on desktop only.',
  'claudeProfiles.intro':
    'Register your Claude Code settings.json files. Tasks can pick a profile and model; the AI run launches with claude --settings <path>. Auth tokens in the files are never read or shown.',
  'claudeProfiles.registered': 'Registered profiles',
  'claudeProfiles.loading': 'Loading…',
  'claudeProfiles.empty': 'No profiles yet.',
  'claudeProfiles.unreadable': 'file unreadable',
  'claudeProfiles.remove': 'Remove',
  'claudeProfiles.addTitle': 'Add a profile',
  'claudeProfiles.addDesc':
    'Point to a settings.json file, e.g. ~/.claude/settings.json.hyperspace',
  'claudeProfiles.nameLabel': 'Name',
  'claudeProfiles.namePlaceholder': 'e.g. Hyperspace',
  'claudeProfiles.pathLabel': 'Settings file path',
  'claudeProfiles.adding': 'Adding…',
  'claudeProfiles.add': 'Add profile',
  'claudeProfiles.picker.none': 'No Claude settings profiles yet — add one in Settings.',
  'claudeProfiles.picker.default': 'Default (no profile)',
  'claudeProfiles.picker.modelDefault': 'Default model',
  'claudeProfiles.parsing': 'Parsing…',
  'claudeProfiles.previewUnreadable': 'File not found or unreadable.',
  'claudeProfiles.previewNoModels': 'No model keys found in this file.',
  'claudeProfiles.ladderTitle': 'Fallback ladder',
  ...
  'claudeProfiles.ladderEmpty': 'Add a profile to build the ladder.',
  'claudeProfiles.picker.fallback': 'Fallback on startup failure',
  'claudeProfiles.picker.down': 'Step down ladder',
  'claudeProfiles.picker.up': 'Step up ladder',
  'claudeProfiles.picker.endBoundary': 'End: ladder boundary',
  'claudeProfiles.picker.endPrefix': 'End at',
  'claudeProfiles.globalTitle': 'Global default (tasks without a profile)',
  ...
  'claudeProfiles.globalEnable': 'Enable global default fallback',
  'claudeProfiles.globalStart': 'Start model…',
  'claudeProfiles.globalNoLadder': 'Add a profile first to build the ladder.',
  'claudeProfiles.globalSentStart': 'Start at',
  'claudeProfiles.globalSentStep': 'and step',
  'claudeProfiles.globalSentDown': 'down',
