...
const messages: TranslationMap = {
  ...
  'topics.tab': 'Темы',
  'topics.title': 'Ветки тем',
  'topics.subtitle': 'Объединяйте контент из разных источников в хронологию по теме.',
  'topics.new': '+ Новая тема',
  'topics.newTitle': 'Новая тема',
  'topics.editTitle': 'Редактировать тему',
  'topics.loading': 'Загрузка…',
  'topics.emptyTitle': 'Тем пока нет',
  'topics.emptyDesc':
    'Создайте тему, чтобы автоматически объединять связанные письма, чаты и встречи.',
  'topics.chip.keywords': 'ключевые слова',
  'topics.chip.sources': 'источники',
  'topics.chip.entities': 'люди',
  'topics.field.name': 'Название',
  'topics.field.namePlaceholder': 'напр. Проект Феникс Q3',
  'topics.field.description': 'Описание',
  'topics.field.descriptionPlaceholder': 'Что охватывает эта тема…',
  'topics.field.keywordLogic': 'Совпадение ключевых слов',
  'topics.logic.or': 'Любое слово (ИЛИ)',
  'topics.logic.and': 'Все слова (И)',
  'topics.field.keywords': 'Ключевые слова',
  'topics.field.keywordsPlaceholder': 'Введите слово, нажмите Enter',
  'topics.field.sources': 'Закреплённые источники',
  'topics.field.noSources': 'Источники памяти не настроены.',
  'topics.field.entities': 'Закреплённые люди / сущности',
  'topics.field.entitiesPlaceholder': 'напр. person:jane-doe, нажмите Enter',
  'topics.timeline': 'Хронология',
  'topics.timelineEmpty': 'Контент ещё не объединён — ожидание следующей синхронизации/сводки.',
  'topics.current': 'Текущее',
  'topics.save': 'Сохранить',
  'topics.saving': 'Сохранение…',
  'topics.cancel': 'Отмена',
  'topics.delete': 'Удалить тему',
  'topics.confirmDelete': 'Удалить эту тему? Объединённые сводки сохранятся.',
  'topics.err.nameRequired': 'Название обязательно.',
  'topics.chip.conversations': 'чаты',
  'topics.chip.people': 'люди',
  'topics.field.conversations': 'Чаты Teams',
  'topics.field.noConversations': 'Пока нет чатов Teams — сначала синхронизируйте сообщения Teams.',
  'topics.field.searchConversations': 'Поиск чатов по имени…',
  'topics.field.people': 'Люди',
  'topics.field.noPeople': 'Пока нет людей — сначала синхронизируйте почту или Teams.',
  'topics.field.searchPeople': 'Поиск людей по имени или email…',
  'topics.field.pasteLink': 'Вставьте ссылку на чат Teams…',
  'topics.field.addLink': 'Добавить',
  'topics.field.resolving': 'Разрешение…',
  'topics.chip.meetings': 'встречи',
  'topics.field.meetings': 'Встречи',
  'topics.field.meetingsPlaceholder': 'Введите название встречи или его часть, нажмите Enter',
  'topics.field.noMeetings': 'Пока нет встреч — сначала синхронизируйте расшифровки Teams.',
  'topics.field.searchMeetings': 'Поиск встреч по названию…',
  'topics.field.backfill': 'Заполнить историю',
  'topics.backfill.none': 'Нет',
  'topics.backfill.label': 'Заполнить:',
  'topics.backfill.done': 'Заполнение поставлено в очередь — хронология скоро обновится.',
  // Claude settings profiles
  'claudeProfiles.title': 'Профили Claude',
  'claudeProfiles.menuDesc': 'Зарегистрируйте файлы settings.json Claude Code и их модели',
  'claudeProfiles.desktopOnly': 'Доступно только на компьютере.',
  'claudeProfiles.intro':
    'Зарегистрируйте свои файлы settings.json Claude Code. Задачи могут выбирать профиль и модель; запуск ИИ выполняется через claude --settings <путь>. Токены аутентификации в файлах никогда не читаются и не отображаются.',
  'claudeProfiles.registered': 'Зарегистрированные профили',
  'claudeProfiles.loading': 'Загрузка…',
  'claudeProfiles.empty': 'Профилей пока нет.',
  'claudeProfiles.unreadable': 'файл не читается',
  'claudeProfiles.remove': 'Удалить',
  'claudeProfiles.addTitle': 'Добавить профиль',
  'claudeProfiles.addDesc': 'Укажите файл settings.json, напр. ~/.claude/settings.json.hyperspace',
  'claudeProfiles.nameLabel': 'Имя',
  'claudeProfiles.namePlaceholder': 'напр. Hyperspace',
  'claudeProfiles.pathLabel': 'Путь к файлу settings',
  'claudeProfiles.adding': 'Добавление…',
  'claudeProfiles.add': 'Добавить профиль',
  'claudeProfiles.picker.none': 'Профилей Claude пока нет — добавьте в настройках.',
  'claudeProfiles.picker.default': 'По умолчанию (без профиля)',
  'claudeProfiles.picker.modelDefault': 'Модель по умолчанию',
  'claudeProfiles.parsing': 'Разбор…',
  'claudeProfiles.previewUnreadable': 'Файл не найден или не читается.',
  'claudeProfiles.previewNoModels': 'В этом файле не найдены ключи моделей.',
  'claudeProfiles.ladderTitle': 'Лестница отката',
  'claudeProfiles.ladderDesc':
    'Глобальный порядок моделей для отката задач. Задача откатывается по этой лестнице (вверх или вниз), когда её модель не запускается.',
  'claudeProfiles.ladderEmpty': 'Добавьте профиль, чтобы построить лестницу.',
  'claudeProfiles.picker.fallback': 'Откат при сбое запуска',
  'claudeProfiles.picker.down': 'Вниз по лестнице',
  'claudeProfiles.picker.up': 'Вверх по лестнице',
  'claudeProfiles.picker.endBoundary': 'Конец: граница лестницы',
  'claudeProfiles.picker.endPrefix': 'Конец на',
  'claudeProfiles.globalTitle': 'Глобальный по умолчанию (задачи без профиля)',
  'claudeProfiles.globalDesc':
    'Задачи без собственного профиля используют этот откат. Выкл = выполняются с моделью приложения по умолчанию.',
  'claudeProfiles.globalEnable': 'Включить глобальный откат по умолчанию',
  'claudeProfiles.globalStart': 'Начальная модель…',
  'claudeProfiles.globalNoLadder': 'Сначала добавьте профиль, чтобы построить лестницу.',
  'claudeProfiles.globalSentStart': 'Начать с',
  'claudeProfiles.globalSentStep': 'и двигаться',
  'claudeProfiles.globalSentDown': 'вниз',
