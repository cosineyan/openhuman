...
const messages: TranslationMap = {
  ...
  'topics.tab': 'विषय',
  'topics.title': 'विषय थ्रेड',
  'topics.subtitle': 'कई स्रोतों की सामग्री को एक विषय टाइमलाइन में इकट्ठा करें।',
  'topics.new': '+ नया विषय',
  'topics.newTitle': 'नया विषय',
  'topics.editTitle': 'विषय संपादित करें',
  'topics.loading': 'लोड हो रहा है…',
  'topics.emptyTitle': 'अभी कोई विषय नहीं',
  'topics.emptyDesc': 'संबंधित ईमेल, चैट और मीटिंग को स्वतः इकट्ठा करने के लिए एक विषय बनाएं।',
  'topics.chip.keywords': 'कीवर्ड',
  'topics.chip.sources': 'स्रोत',
  'topics.chip.entities': 'लोग',
  'topics.field.name': 'नाम',
  'topics.field.namePlaceholder': 'जैसे प्रोजेक्ट फीनिक्स Q3',
  'topics.field.description': 'विवरण',
  'topics.field.descriptionPlaceholder': 'यह विषय क्या कवर करता है…',
  'topics.field.keywordLogic': 'कीवर्ड मिलान',
  'topics.logic.or': 'कोई भी कीवर्ड (OR)',
  'topics.logic.and': 'सभी कीवर्ड (AND)',
  'topics.field.keywords': 'कीवर्ड',
  'topics.field.keywordsPlaceholder': 'कीवर्ड लिखें, Enter दबाएँ',
  'topics.field.sources': 'पिन किए गए स्रोत',
  'topics.field.noSources': 'कोई मेमोरी स्रोत कॉन्फ़िगर नहीं है।',
  'topics.field.entities': 'पिन किए गए लोग / एंटिटी',
  'topics.field.entitiesPlaceholder': 'जैसे person:jane-doe, Enter दबाएँ',
  'topics.timeline': 'टाइमलाइन',
  'topics.timelineEmpty': 'अभी कोई सामग्री इकट्ठा नहीं हुई — अगले सिंक/सारांश की प्रतीक्षा।',
  'topics.current': 'वर्तमान',
  'topics.save': 'सहेजें',
  'topics.saving': 'सहेजा जा रहा है…',
  'topics.cancel': 'रद्द करें',
  'topics.delete': 'विषय हटाएँ',
  'topics.confirmDelete': 'यह विषय हटाएँ? इकट्ठा किए गए सारांश रहेंगे।',
  'topics.err.nameRequired': 'नाम आवश्यक है।',
  'topics.chip.conversations': 'चैट',
  'topics.chip.people': 'लोग',
  'topics.field.conversations': 'Teams चैट',
  'topics.field.noConversations': 'अभी कोई Teams चैट नहीं — पहले Teams संदेश सिंक करें।',
  'topics.field.searchConversations': 'नाम से चैट खोजें…',
  'topics.field.people': 'लोग',
  'topics.field.noPeople': 'अभी कोई व्यक्ति नहीं — पहले ईमेल या Teams सिंक करें।',
  'topics.field.searchPeople': 'नाम या ईमेल से लोग खोजें…',
  'topics.field.pasteLink': 'Teams चैट लिंक पेस्ट करें…',
  'topics.field.addLink': 'जोड़ें',
  'topics.field.resolving': 'हल हो रहा है…',
  'topics.chip.meetings': 'मीटिंग',
  'topics.field.meetings': 'मीटिंग',
  'topics.field.meetingsPlaceholder': 'मीटिंग नाम या उसका हिस्सा लिखें, Enter दबाएँ',
  'topics.field.noMeetings': 'अभी कोई मीटिंग नहीं — पहले Teams ट्रांसक्रिप्ट सिंक करें।',
  'topics.field.searchMeetings': 'नाम से मीटिंग खोजें…',
  'topics.field.backfill': 'इतिहास भरें',
  'topics.backfill.none': 'कोई नहीं',
  'topics.backfill.label': 'भरें:',
  'topics.backfill.done': 'बैकफ़िल कतारबद्ध — टाइमलाइन जल्द अपडेट होगी।',
  // Claude settings profiles
  'claudeProfiles.title': 'Claude प्रोफ़ाइल',
  'claudeProfiles.menuDesc': 'Claude Code settings.json फ़ाइलें और उनके मॉडल पंजीकृत करें',
  'claudeProfiles.desktopOnly': 'केवल डेस्कटॉप पर उपलब्ध।',
  'claudeProfiles.intro':
    'अपनी Claude Code settings.json फ़ाइलें पंजीकृत करें। कार्य एक प्रोफ़ाइल और मॉडल चुन सकते हैं; AI रन claude --settings <path> से शुरू होता है। फ़ाइलों के टोकन कभी नहीं पढ़े या दिखाए जाते।',
  'claudeProfiles.registered': 'पंजीकृत प्रोफ़ाइल',
  'claudeProfiles.loading': 'लोड हो रहा है…',
  'claudeProfiles.empty': 'अभी कोई प्रोफ़ाइल नहीं।',
  'claudeProfiles.unreadable': 'फ़ाइल अपठनीय',
  'claudeProfiles.remove': 'हटाएँ',
  'claudeProfiles.addTitle': 'प्रोफ़ाइल जोड़ें',
  'claudeProfiles.addDesc':
    'किसी settings.json फ़ाइल की ओर इशारा करें, जैसे ~/.claude/settings.json.hyperspace',
  'claudeProfiles.nameLabel': 'नाम',
  'claudeProfiles.namePlaceholder': 'जैसे Hyperspace',
  'claudeProfiles.pathLabel': 'settings फ़ाइल पथ',
  'claudeProfiles.adding': 'जोड़ रहे हैं…',
  'claudeProfiles.add': 'प्रोफ़ाइल जोड़ें',
  'claudeProfiles.picker.none': 'अभी कोई Claude प्रोफ़ाइल नहीं — सेटिंग्स में जोड़ें।',
  'claudeProfiles.picker.default': 'डिफ़ॉल्ट (कोई प्रोफ़ाइल नहीं)',
  'claudeProfiles.picker.modelDefault': 'डिफ़ॉल्ट मॉडल',
  'claudeProfiles.parsing': 'विश्लेषण हो रहा है…',
  'claudeProfiles.previewUnreadable': 'फ़ाइल नहीं मिली या अपठनीय।',
  'claudeProfiles.previewNoModels': 'इस फ़ाइल में कोई मॉडल कुंजी नहीं मिली।',
  'claudeProfiles.ladderTitle': 'फ़ॉलबैक सीढ़ी',
  'claudeProfiles.ladderDesc':
    'कार्य फ़ॉलबैक द्वारा उपयोग किया जाने वाला वैश्विक मॉडल क्रम। मॉडल शुरू न होने पर कार्य इस सीढ़ी पर (ऊपर या नीचे) फ़ॉलबैक करता है।',
  'claudeProfiles.ladderEmpty': 'सीढ़ी बनाने के लिए एक प्रोफ़ाइल जोड़ें।',
  'claudeProfiles.picker.fallback': 'शुरुआत विफलता पर फ़ॉलबैक',
  'claudeProfiles.picker.down': 'सीढ़ी नीचे',
  'claudeProfiles.picker.up': 'सीढ़ी ऊपर',
  'claudeProfiles.picker.endBoundary': 'अंत: सीढ़ी सीमा',
  'claudeProfiles.picker.endPrefix': 'यहाँ समाप्त',
  'claudeProfiles.globalTitle': 'वैश्विक डिफ़ॉल्ट (बिना प्रोफ़ाइल वाले कार्य)',
  'claudeProfiles.globalDesc':
    'जो कार्य अपनी प्रोफ़ाइल नहीं चुनते, वे इस फ़ॉलबैक का उपयोग करते हैं। बंद = ऐप डिफ़ॉल्ट मॉडल से चलते हैं।',
  'claudeProfiles.globalEnable': 'वैश्विक डिफ़ॉल्ट फ़ॉलबैक सक्षम करें',
  'claudeProfiles.globalStart': 'आरंभ मॉडल…',
  'claudeProfiles.globalNoLadder': 'सीढ़ी बनाने के लिए पहले प्रोफ़ाइल जोड़ें।',
  'claudeProfiles.globalSentStart': 'यहाँ से शुरू',
  'claudeProfiles.globalSentStep': 'और जाएँ',
  'claudeProfiles.globalSentDown': 'नीचे',
