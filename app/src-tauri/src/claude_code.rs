...
///
/// A system prompt is appended instructing claude to output `DONE: <summary>`
/// when the task is complete, so the background session watcher can detect
/// completion and update the task automatically.
///
